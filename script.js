...
const filterRecipes = () => {
  ...
  updateURLParameters(searchValue, appareilSelected, ustensilesSelected, ingredientsSelected);
  updateActiveFilters({
...
const displayPage = () => {
  ...
  if (Array.isArray(recipesData.recipes)) {
    updateFilterOptions(recipesData.recipes);
    displayRecipes(recipesData.recipes);
  } else {
    console.error("Les données des recettes ne sont pas valides.");
  }
};
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  filterRecipes();  // Filtre les recettes en fonction des paramètres de l'URL
